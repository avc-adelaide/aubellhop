---
title: "AUBELLHOP: sound speed profiles"
format:
  html:
    code-fold: true
jupyter: python3
...
The data has been included in the `aubellhop` repository (it is not too large), and the code below adapted from Brian's Matlab examples.
...
#| fig-cap: "Worldwide sound speed profile for constant longitude (NOAA World Ocean Atlas) — converted to distance for use by `aubellhop.`."
